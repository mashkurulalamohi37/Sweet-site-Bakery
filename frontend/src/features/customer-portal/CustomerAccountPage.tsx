      ...
      login(
        {
          id: 1,
          email: email,
          name: email.split('@')[0] || 'Sweet Site Customer',
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="admin@sweetsite.com or user@gmail.com"
                  className="w-full text-xs px-3.5 py-2.5 rounded-xl bg-brand-cream/40 border border-brand-brown/10 focus:outline-none focus:ring-1 focus:ring-brand-brown"
                />
              </div>
              ...
              <div className="p-3 bg-brand-cream/40 rounded-xl text-[11px] text-brand-muted text-center">
                <p>
                  <strong>Demo Admin Access:</strong> <br />
                  Login with <code>admin@sweetsite.com</code> (any password) to access the full SaaS Admin Management Portal.
                </p>
              </div>
            </form>
          </div>
